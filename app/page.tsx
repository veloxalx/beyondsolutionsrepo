...
export default function Home() {
  ...
  return (
    <main className={cn("min-h-screen flex flex-col bg-white", isLoaded ? "opacity-100" : "opacity-0")}>
      ...
      <section
        ref={heroRef}
        className="relative w-full min-h-screen flex items-center pt-32 pb-24 overflow-hidden bg-black"
      >
        {/* Background elements */}
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight tracking-tight">
                <span className="block">Transforming Businesses with</span>
          ...
          <div className="flex items-center justify-center gap-6 pt-16">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-14 h-14 rounded-full border-2 border-black bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center overflow-hidden shadow-lg"
                >
        ...
        <div className="absolute bottom-10 left-0 right-0 flex justify-center">
          ...
          >
            <span className="text-white/50 text-sm">Explore Excellence</span>
            <div className="w-6 h-10 rounded-full border-2 border-white/20 flex items-center justify-center p-1">
