  ...
  const services = [
    {
      ...
      description:
        "Transform your business strategy with data-driven insights, market analysis, and proven methodologies that deliver measurable results and sustainable competitive advantage.",
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Modernize your operations with cutting-edge technology solutions, seamless digital integration, and automation that drives efficiency and innovation across your organization.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Maximize efficiency and ROI through systematic process improvements, performance analytics, and optimization strategies that deliver tangible business outcomes.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Build exceptional leadership capabilities across your organization with proven development programs, mentoring, and executive coaching that creates lasting impact.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Foster a culture of innovation and drive breakthrough solutions with structured innovation processes, ideation frameworks, and implementation strategies.",
      icon: Lightbulb,
      primaryColor: "from-orange-600 to-orange-400",
      accentColor: "from-orange-700 to-orange-500",
      bgGradient: "from-orange-600/20 via-orange-400/10 to-transparent",
    ...
    },
    {
      ...
      description:
        "Protect and future-proof your business with comprehensive risk strategies, mitigation plans, and contingency frameworks that ensure business continuity.",
      icon: Shield,
      primaryColor: "from-orange-500 to-orange-400",
      accentColor: "from-orange-600 to-orange-500",
      bgGradient: "from-orange-500/20 via-orange-400/10 to-transparent",
    ...
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-br ${currentService.bgGradient} transition-all duration-1000 ease-out`}
          ></div>
        ...
        >
          <div className="text-center max-w-5xl mx-auto mb-8 sm:mb-12 lg:mb-16">
            ...
            >
              ...
              >
                We deliver unmatched strategic consulting and implementation
                services that drive exceptional business results for elite
                organizations seeking unprecedented growth and market
                leadership.
              </motion.p>
            </motion.div>
          </div>
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        {currentService.features.map((feature, index) => (
                          ...
                          >
                            <div
                              className={`w-6 h-6 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-gradient-to-r ${currentService.primaryColor} flex items-center justify-center shadow-lg`}
                            >
                              <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                            </div>
                            <span className="text-sm sm:text-base text-gray-300 font-medium group-hover/feature:text-white transition-colors duration-300">
                              {feature}
                            </span>
                          </motion.div>
                        ))}
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="min-w-0">
                            <p className="text-white font-bold text-sm sm:text-base lg:text-xl truncate">
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 flex items-center justify-center gap-3 sm:gap-4">
                ...
                <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-white group-hover:translate-x-2 transition-transform duration-300" />
              </span>
            </motion.button>
            ...
            >
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
              />
              <span className="relative z-10 text-sm sm:text-base lg:text-xl">
