    ...
    <section className="w-full py-32 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Badge className="mb-4 bg-[#F5A623]/10 text-[#F5A623] hover:bg-[#F5A623]/20">Business Solutions</Badge>
          <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 tracking-tight">
            Solving Your Most Critical Business Challenges
          </h2>
                  ...
                  {activeTab === "solution" && (
                    <div className="space-y-6">
                      ...
                      <div className="bg-gradient-to-r from-[#F5A623]/10 to-transparent p-6 rounded-xl mt-6">
                        <h5 className="font-semibold mb-3">Why Our Approach Works</h5>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="flex items-start gap-3">
                            <div className="w-5 h-5 rounded-full bg-[#F5A623]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <Check className="h-3 w-3 text-[#F5A623]" />
                            </div>
                            <span className="text-gray-700">Data-driven methodology with proven results</span>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-5 h-5 rounded-full bg-[#F5A623]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <Check className="h-3 w-3 text-[#F5A623]" />
                            </div>
                            <span className="text-gray-700">Industry-specific expertise and benchmarks</span>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-5 h-5 rounded-full bg-[#F5A623]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <Check className="h-3 w-3 text-[#F5A623]" />
                            </div>
                            <span className="text-gray-700">Customized to your specific business context</span>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-5 h-5 rounded-full bg-[#F5A623]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <Check className="h-3 w-3 text-[#F5A623]" />
                            </div>
                            <span className="text-gray-700">Continuous optimization and adaptation</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        {activeSolution.results.map((result, i) => (
                          <div key={i} className="bg-gray-50 rounded-xl p-6">
                            ...
                            <p className="text-gray-600">
                              {i === 0
                                ? "Consistently achieved across client engagements through our targeted strategies."
                                : i === 1
                                  ? "Measured through rigorous before-and-after performance analysis."
                                  : i === 2
                                    ? "Sustainable improvements that continue to deliver value over time."
                                    : "Documented ROI that exceeds industry benchmarks."}
                            </p>
                          </div>
                        ))}
                      </div>
        ...
        <div className="mt-16 text-center">
          <Link
            href="/solutions"
            className="inline-flex items-center gap-2 text-[#F5A623] font-medium hover:text-[#F5A623]/80 transition-colors group"
          >
