      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            We deliver superior solutions that outperform the competition and drive exceptional results.
          </p>
        </div>
                ...
                <div className="p-6 md:p-8">
                  {activeTab === "overview" && (
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-50 rounded-xl p-6">
                          <h4 className="text-lg font-semibold mb-2">Our Elite Solution</h4>
                          <p className="text-gray-700">{activeSolution.solution}</p>
                        </div>
                      </div>

                      <div>
                        <h4 className="text-lg font-semibold mb-4">Superior Results</h4>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <h4 className="text-lg font-semibold">Elite Success Story</h4>
                            </div>
                            <p className="text-gray-600">
                              <span className="font-medium">{activeSolution.caseStudy.company}</span> |{" "}
                              {activeSolution.caseStudy.industry}
                            </p>
                            <p className="text-[#F5A623] font-semibold mt-1">{activeSolution.caseStudy.result}</p>
                          </div>
                  ...
                  {activeTab === "solution" && (
                    <div className="space-y-6">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="text-xl font-semibold">Our Elite Solution Approach</h4>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                        <div className="bg-gray-50 rounded-xl p-6">
                          ...
                          <h5 className="font-semibold mb-3 text-gray-900">Elite Assessment</h5>
                          <p className="text-gray-600">
                            {activeSolution.id === "revenue-growth"
                        ...
                        <div className="bg-gray-50 rounded-xl p-6">
                          ...
                          <h5 className="font-semibold mb-3 text-gray-900">Premium Strategy</h5>
                          <p className="text-gray-600">
                            {activeSolution.id === "revenue-growth"
                        ...
                        <div className="bg-gray-50 rounded-xl p-6">
                          ...
                          <h5 className="font-semibold mb-3 text-gray-900">Elite Implementation</h5>
                          <p className="text-gray-600">
                            {activeSolution.id === "revenue-growth"
                  ...
                  {activeTab === "results" && (
                    <div className="space-y-6">
                      <div className="flex items-center gap-2 mb-2">
                        <Trophy className="h-5 w-5 text-[#F5A623]" />
                        <h4 className="text-xl font-semibold">Superior Results</h4>
                      </div>
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Our clients consistently achieve exceptional results that outperform industry benchmarks through
                        our elite methodologies and tailored solutions.
                      </p>
                      ...
                      <div className="bg-gradient-to-r from-[#F5A623]/10 to-transparent p-6 rounded-xl mt-6">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <Trophy className="h-4 w-4 text-[#F5A623]" />
                              <h5 className="font-semibold text-lg">Elite Success Story</h5>
                            </div>
