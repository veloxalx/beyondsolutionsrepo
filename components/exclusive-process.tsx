    ...
    <section className="w-full py-24 bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          >
            Our exclusive methodology ensures superior results and exceptional
            outcomes for every client through our proven five-stage
          ...
          {process.map((item, i) => (
            <div
              ...
              className={`relative flex flex-col md:flex-row gap-8 items-center md:items-start mb-20 ${
                i % 2 === 0
                  ? "md:text-left"
                  : "md:text-right md:flex-row-reverse"
              }`}
            >
              {/* Step Number Circle */}
              <motion.div
              ...
              >
                ...
                {/* Connecting dots */}
                <div
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full border-2 border-orange-500/20 animate-spin"
              ...
              <div
                ...
                } h-px bg-gradient-to-r from-orange-500/30 to-transparent`}
              ></div>
            </div>
          ))}
        </div>
