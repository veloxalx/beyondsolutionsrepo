  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? "bg-white/90 backdrop-blur-md shadow-lg py-5" : "bg-transparent py-10 text-white",
      )}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-10">
            <div className="relative group" onMouseLeave={closeDropdowns}>
              <button
                className={cn(
                  "font-medium transition-colors flex items-center gap-1 text-base",
              ...
              <AnimatePresence>
                {activeDropdown === "solutions" && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-72 rounded-xl bg-white/95 backdrop-blur-md shadow-xl border border-gray-200 overflow-hidden z-50"
                  >
                    <div className="p-3">
                      {[
                        ...
                        >
                          <div className="w-10 h-10 rounded-lg bg-[#F5A623]/10 flex items-center justify-center mt-0.5">
          ...
          <div className="hidden lg:block">
            <Button
              className={cn(
                "rounded-full px-10 py-7 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 text-base",
                isScrolled
          ...
          >
            {isMobileMenuOpen ? (
              <X className={cn("h-8 w-8", isScrolled ? "text-black" : "text-white")} />
            ) : (
